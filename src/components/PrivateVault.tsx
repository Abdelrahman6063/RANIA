      ...
      >
        ...
        {stage === "sealed" && (
          <div className="relative">
            ...
            <h3 className="mt-5 font-display text-3xl text-gold-shine">الصندوق الخاص</h3>
            <p className="mt-2 font-serif-ar text-sm text-muted-foreground">
              ٦ رسايل مقفولة… ليكي إنتِ بس 🤍
            </p>
            <button
        ...
        {stage === "open" && (
          <div className="relative">
            <div className="flex items-center justify-center gap-2">
              ...
              <h3 className="font-display text-3xl text-gold-shine">الصندوق الخاص</h3>
            </div>
            <p className="mt-2 font-serif-ar text-sm text-muted-foreground">
              اتفتح… اقري براحتك 🤍
            </p>
