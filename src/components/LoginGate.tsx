...
export function LoginGate({
  ...
  return (
    ...
    >
      ...
      <h1
        className={`font-display text-gold-shine leading-tight ${compact ? "text-4xl" : "text-6xl sm:text-7xl"}`}
        style={{ letterSpacing: "0.06em" }}
      >
        {title}
      </h1>
      <p className="mt-3 font-body text-[11px] tracking-[0.35em] text-muted-foreground">
        {subtitle}
      </p>
