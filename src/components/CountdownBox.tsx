...
const START = new Date(2025, 6, 14, 0, 0, 0); // 14 July 2025
  ...
  return (
    <div className="animate-rise-in flex flex-col items-center" style={{ animationDelay: `${delay}ms` }}>
      <div className="relative h-[104px] w-[104px] sm:h-28 sm:w-28">
        ...
        >
          <span className="font-ornate font-bold text-2xl text-gold-shine tabular-nums leading-none">
            {value}
          </span>
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="relative font-ornate font-bold text-2xl text-gold-shine tabular-nums">
...
export function CountdownBox() {
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-2 font-ornate font-bold text-3xl text-gold-shine tabular-nums">14 / 07 / 2025</h3>
      ...
      {d && (
        <>
          ...
          <p className="mt-6 font-serif-ar text-base text-foreground/90">
            يعني بقالنا <span className="text-gold-shine font-ornate font-bold">{d.totalDays}</span> يوم
            {" · "}
            <span className="text-gold-shine font-ornate font-bold">{d.totalHours}</span> ساعة ♥
          </p>
        </>
      )}
    </div>
